aAAa;IACb,6BAA6B;IAC7B,mBAAmB;IACnB,4CAA4C;IAC5C,aAAa;IACb,SAAS;;IAET;MACE,aAAa;MACb,sBAAsB;MACtB,uBAAuB;MACvB,mBAAmB;MACnB,WAAW;MACX,gBAAgB;MAChB,4BAA4B;;MAE5B;QACE,6BAA6B;QAC7B,gBAAgB;MAClB;;MAEA;QACE,WAAW;QACX,YAAY;QACZ,uBAAuB;MACzB;IACF;EACF;AACF;;AAEA;EACE;IACE,uBAAuB;EACzB;EACA;IACE,yBAAyB;EAC3B;AACF","sourcesContent":["* {\n  box-sizing: border-box;\n  margin: 0;\n  padding: 0;\n}\n\n@import url('https://fonts.googleapis.com/css2?family=Teko:wght@300;400;500;600;700&display=swap');\n\n:root {\n  --font-header: 48px;\n  --font-large: 38px;\n  --font-medium: 32px;\n  --font-small: 26px;\n  --font-xsmall: 20px;\n  --color-primary: #0182de;\n  --color-primaryalt: #00bbff;\n  --color-secondary: #ffffff;\n  --color-secondaryalt: #eeeeee;\n}\n\nbody {\n  height: 100dvh;\n  display: flex;\n  flex-direction: column;\n  font-family: Teko;\n  background-color: var(--color-primary);\n\n  & button {\n    cursor: pointer;\n  }\n}\n\nheader {\n  background: linear-gradient(\n    180deg,\n    var(--color-primaryalt) 0%,\n    var(--color-primary) 100%\n  );\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n  padding: 1.5rem;\n\n  & h1 {\n    color: var(--color-secondary);\n    background-color: var(--color-primary);\n    border-radius: 20px 0 20px 0;\n    padding: 0 1rem;\n    user-select: none;\n    border: 4px solid var(--color-secondary);\n  }\n\n  & input {\n    background-color: var(--color-secondaryalt);\n    border-style: none;\n    padding: 5px;\n    border-radius: 12px;\n    border-radius: 5px 0 0 5px;\n    padding-left: 1ch;\n    font-size: var(--font-xsmall);\n    transition: background-color 300ms;\n\n    &:hover {\n      background-color: var(--color-secondary);\n    }\n\n    &:focus {\n      background-color: var(--color-secondary);\n      outline: none;\n    }\n  }\n\n  & button {\n    background-color: var(--color-secondary);\n    font-family: Teko;\n    font-size: var(--font-xsmall);\n    border-style: none;\n    padding: 3px 15px;\n  }\n\n  & #search-container {\n    display: flex;\n    position: relative;\n\n    & #loader {\n      align-self: center;\n      position: absolute;\n      border-radius: 50%;\n      border-top: 3px solid var(--color-secondary);\n      width: 30px;\n      height: 30px;\n      right: -50px;\n      animation: spin 1.5s linear infinite;\n    }\n\n    & button {\n      background-color: var(--color-secondary);\n      color: var(--color-primary);\n      border-radius: 0 5px 5px 0;\n      transition: background-color 300ms;\n\n      &:hover {\n        background-color: var(--color-secondaryalt);\n      }\n    }\n  }\n\n  & #units-container {\n    display: flex;\n    gap: 12px;\n\n    & button {\n      color: var(--color-primary);\n      border-radius: 5px;\n      opacity: 0.75;\n      transition: opacity 300ms;\n    }\n\n    & .active {\n      opacity: 1;\n    }\n  }\n}\n\nmain {\n  color: var(--color-secondary);\n  opacity: 0;\n  padding: 1rem 15%;\n  display: grid;\n  grid-template-rows: 1fr 3fr;\n  grid-template-columns: 1fr 3fr;\n  transition: opacity 600ms;\n\n  & #info-location {\n    grid-column: span 2;\n    display: flex;\n    flex-direction: column;\n    justify-content: center;\n    align-items: center;\n\n    & p:nth-child(1) {\n      font-size: var(--font-header);\n      font-weight: 500;\n    }\n\n    & p:nth-child(2) {\n      font-size: var(--font-large);\n      font-weight: 300;\n    }\n  }\n\n  & #info-temp {\n    display: flex;\n    flex-direction: column;\n    justify-content: center;\n    align-items: center;\n    font-size: var(--font-small);\n    font-weight: 400;\n\n    & p:nth-child(1) {\n      font-size: var(--font-medium);\n    }\n\n    & img {\n      width: 80px;\n      height: 80px;\n      filter: grayscale(100%);\n    }\n  }\n\n  & #info-grid {\n    display: grid;\n    grid-template-columns: repeat(3, 1fr);\n\n    & .info-item {\n      display: grid;\n      grid-template-columns: 1fr 2fr;\n\n      & div {\n        justify-self: start;\n        align-self: end;\n        font-size: var(--font-medium);\n        font-weight: 500;\n        padding-left: 0.5rem;\n      }\n\n      & p {\n        font-size: var(--font-small);\n        font-weight: 300;\n        padding-left: 0.85rem;\n      }\n\n      & img {\n        align-self: center;\n        justify-self: end;\n        width: 60px;\n        height: 60px;\n        grid-row: 1 / 3;\n        filter: invert(100%);\n      }\n    }\n  }\n\n  & #info-forecast {\n    display: flex;\n    justify-content: space-around;\n    grid-column: span 2;\n    border-top: 1px solid var(--color-secondary);\n    padding: 2rem;\n    gap: 1rem;\n\n    & .forecast-card {\n      display: flex;\n      flex-direction: column;\n      justify-content: center;\n      align-items: center;\n      width: 100%;\n      font-weight: 300;\n      font-size: var(--font-small);\n\n      & p:nth-child(1) {\n        font-size: var(--font-medium);\n        font-weight: 500;\n      }\n\n      & img {\n        width: 80px;\n        height: 80px;\n        filter: grayscale(100%);\n      }\n    }\n  }\n}\n\n@keyframes spin {\n  from {\n    transform: rotate(0deg);\n  }\n  to {\n    transform: rotate(360deg);\n  }\n}\n"],"sourceRoot":""}]);
// Exports
...
function updateInfo(data, unit) {
  ...
  (0,_uiModules__WEBPACK_IMPORTED_MODULE_1__.forecastModule)(data, unit);
}
...
function locationModule(data) {
  ...
  localTime.textContent = (0,date_fns__WEBPACK_IMPORTED_MODULE_6__["default"])(date, 'cccc, MMMM dd');
...
function tempModule(data, useUnit) {
  ...
  hours.textContent = (0,date_fns__WEBPACK_IMPORTED_MODULE_6__["default"])(date, 'HH:mm');
...
function forecastModule(data, unit) {
  data.forecast.forEach((day) => {
    ...
    if (data.forecast.indexOf(day) !== 0)
      dateElement.textContent = (0,date_fns__WEBPACK_IMPORTED_MODULE_6__["default"])(date, 'dd/MM');
    else dateElement.textContent = 'Today';

    weekDayElement.textContent = (0,date_fns__WEBPACK_IMPORTED_MODULE_6__["default"])(date, 'cccc');
...
/* harmony export */ });
/* harmony import */ var _uiModules__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./uiModules */ "./src/uiModules.js");
...
async function fetchWeather(location) {
  (0,_uiModules__WEBPACK_IMPORTED_MODULE_0__.loaderModule)().add();
  ...
  (0,_uiModules__WEBPACK_IMPORTED_MODULE_0__.loaderModule)().remove();
  return data;
}
...
module.exports = __webpack_require__.p + "81796b4fbb689d921444.svg";
...
module.exports = __webpack_require__.p + "20edcb8b2c04f05ec8f7.svg";
...
module.exports = __webpack_require__.p + "7195e5e80f2e55f4c2a6.svg";
