...
header {
  background: linear-gradient(180deg, #00d5ff 0%, #067dd1 100%);
  display: flex;
...
`, "",{"version":3,"sources":["webpack://./src/style.css"],"names":[],"mappings":"AAAA;EACE,sBAAsB;EACtB,SAAS;EACT,UAAU;AACZ;;AAIA;EACE,mBAAmB;EACnB,kBAAkB;EAClB,mBAAmB;EACnB,kBAAkB;EAClB,mBAAmB;AACrB;;AAEA;EACE,cAAc;EACd,aAAa;EACb,sBAAsB;EACtB,iBAAiB;EACjB,yBAAyB;;EAEzB;IACE,eAAe;EACjB;AACF;;AAEA;EACE,6DAA6D;EAC7D,aAAa;EACb,8BAA8B;EAC9B,mBAAmB;EACnB,eAAe;;EAEf;IACE,cAAc;IACd,yBAAyB;IACzB,4BAA4B;IAC5B,eAAe;IACf,iBAAiB;IACjB,yBAAyB;EAC3B;;EAEA;IACE,yBAAyB;IACzB,kBAAkB;IAClB,YAAY;IACZ,mBAAmB;IACnB,0BAA0B;IAC1B,iBAAiB;IACjB,6BAA6B;IAC7B,kCAAkC;;IAElC;MACE,yBAAyB;MACzB,aAAa;IACf;EACF;;EAEA;IACE,yBAAyB;IACzB,iBAAiB;IACjB,6BAA6B;IAC7B,kBAAkB;IAClB,iBAAiB;EACnB;;EAEA;IACE,aAAa;;IAEb;MACE,yBAAyB;MACzB,cAAc;MACd,0BAA0B;IAC5B;EACF;;EAEA;IACE,aAAa;IACb,SAAS;;IAET;MACE,cAAc;MACd,kBAAkB;MAClB,aAAa;MACb,yBAAyB;IAC3B;;IAEA;MACE,UAAU;IACZ;EACF;AACF;;AAEA;EACE,YAAY;EACZ,UAAU;EACV,iBAAiB;EACjB,aAAa;EACb,2BAA2B;EAC3B,8BAA8B;EAC9B,yBAAyB;;EAEzB;IACE,mBAAmB;IACnB,aAAa;IACb,sBAAsB;IACtB,uBAAuB;IACvB,mBAAmB;;IAEnB;MACE,6BAA6B;MAC7B,gBAAgB;IAClB;IACA;MACE,4BAA4B;MAC5B,gBAAgB;IAClB;EACF;EACA;IACE,aAAa;IACb,sBAAsB;IACtB,uBAAuB;IACvB,mBAAmB;IACnB,4BAA4B;IAC5B,gBAAgB;;IAEhB;MACE,6BAA6B;IAC/B;;IAEA;MACE,WAAW;MACX,YAAY;IACd;EACF;EACA;IACE,aAAa;IACb,qCAAqC;;IAErC;MACE,aAAa;MACb,8BAA8B;;MAE9B;QACE,mBAAmB;QACnB,eAAe;QACf,6BAA6B;QAC7B,gBAAgB;QAChB,oBAAoB;MACtB;;MAEA;QACE,4BAA4B;QAC5B,gBAAgB;QAChB,qBAAqB;MACvB;;MAEA;QACE,kBAAkB;QAClB,iBAAiB;QACjB,WAAW;QACX,YAAY;QACZ,eAAe;QACf,oBAAoB;MACtB;IACF;EACF;EACA;IACE,aAAa;IACb,6BAA6B;IAC7B,mBAAmB;IACnB,6BAA6B;IAC7B,aAAa;IACb,SAAS;;IAET;MACE,aAAa;MACb,sBAAsB;MACtB,uBAAuB;MACvB,mBAAmB;MACnB,WAAW;MACX,gBAAgB;MAChB,4BAA4B;;MAE5B;QACE,6BAA6B;QAC7B,gBAAgB;MAClB;;MAEA;QACE,WAAW;QACX,YAAY;MACd;IACF;EACF;AACF","sourcesContent":["* {\n  box-sizing: border-box;\n  margin: 0;\n  padding: 0;\n}\n\n@import url('https://fonts.googleapis.com/css2?family=Teko:wght@300;400;500;600;700&display=swap');\n\n:root {\n  --font-header: 48px;\n  --font-large: 38px;\n  --font-medium: 32px;\n  --font-small: 26px;\n  --font-xsmall: 20px;\n}\n\nbody {\n  height: 100dvh;\n  display: flex;\n  flex-direction: column;\n  font-family: Teko;\n  background-color: #067dd1;\n\n  & button {\n    cursor: pointer;\n  }\n}\n\nheader {\n  background: linear-gradient(180deg, #00d5ff 0%, #067dd1 100%);\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n  padding: 1.5rem;\n\n  & h1 {\n    color: #ffffff;\n    background-color: #067dd1;\n    border-radius: 20px 0 20px 0;\n    padding: 0 1rem;\n    user-select: none;\n    border: 4px solid #ffffff;\n  }\n\n  & input {\n    background-color: #eeeeee;\n    border-style: none;\n    padding: 5px;\n    border-radius: 12px;\n    border-radius: 5px 0 0 5px;\n    padding-left: 1ch;\n    font-size: var(--font-xsmall);\n    transition: background-color 300ms;\n\n    &:focus {\n      background-color: #ffffff;\n      outline: none;\n    }\n  }\n\n  & button {\n    background-color: #ffffff;\n    font-family: Teko;\n    font-size: var(--font-xsmall);\n    border-style: none;\n    padding: 3px 15px;\n  }\n\n  & #search-container {\n    display: flex;\n\n    & button {\n      background-color: #ffffff;\n      color: #067dd1;\n      border-radius: 0 5px 5px 0;\n    }\n  }\n\n  & #units-container {\n    display: flex;\n    gap: 12px;\n\n    & button {\n      color: #067dd1;\n      border-radius: 5px;\n      opacity: 0.75;\n      transition: opacity 300ms;\n    }\n\n    & .active {\n      opacity: 1;\n    }\n  }\n}\n\nmain {\n  color: white;\n  opacity: 0;\n  padding: 1rem 15%;\n  display: grid;\n  grid-template-rows: 1fr 3fr;\n  grid-template-columns: 1fr 3fr;\n  transition: opacity 600ms;\n\n  & #info-location {\n    grid-column: span 2;\n    display: flex;\n    flex-direction: column;\n    justify-content: center;\n    align-items: center;\n\n    & p:nth-child(1) {\n      font-size: var(--font-header);\n      font-weight: 500;\n    }\n    & p:nth-child(2) {\n      font-size: var(--font-large);\n      font-weight: 300;\n    }\n  }\n  & #info-temp {\n    display: flex;\n    flex-direction: column;\n    justify-content: center;\n    align-items: center;\n    font-size: var(--font-small);\n    font-weight: 400;\n\n    & p:nth-child(1) {\n      font-size: var(--font-medium);\n    }\n\n    & img {\n      width: 80px;\n      height: 80px;\n    }\n  }\n  & #info-grid {\n    display: grid;\n    grid-template-columns: repeat(3, 1fr);\n\n    & .info-item {\n      display: grid;\n      grid-template-columns: 1fr 2fr;\n\n      & div {\n        justify-self: start;\n        align-self: end;\n        font-size: var(--font-medium);\n        font-weight: 500;\n        padding-left: 0.5rem;\n      }\n\n      & p {\n        font-size: var(--font-small);\n        font-weight: 300;\n        padding-left: 0.85rem;\n      }\n\n      & img {\n        align-self: center;\n        justify-self: end;\n        width: 60px;\n        height: 60px;\n        grid-row: 1 / 3;\n        filter: invert(100%);\n      }\n    }\n  }\n  & #info-forecast {\n    display: flex;\n    justify-content: space-around;\n    grid-column: span 2;\n    border-top: 1px solid #ffffff;\n    padding: 2rem;\n    gap: 1rem;\n\n    & .forecast-card {\n      display: flex;\n      flex-direction: column;\n      justify-content: center;\n      align-items: center;\n      width: 100%;\n      font-weight: 300;\n      font-size: var(--font-small);\n\n      & p:nth-child(1) {\n        font-size: var(--font-medium);\n        font-weight: 500;\n      }\n\n      & img {\n        width: 80px;\n        height: 80px;\n      }\n    }\n  }\n}\n"],"sourceRoot":""}]);
// Exports
